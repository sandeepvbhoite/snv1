		                 ...
		                 <div id="types">
		                     <ul>
		                         <li><a href="index.php" >Text/Link</a></li>
	             	             <li><a href="index.php?action=imagepost">Image</a></li>
		                     </ul>
	                    </div>
                 <div id="box">
		                      <form id="status-form" action="index.php" method="post" >
		                      <div id="textBox" >
                              	...
                              	<div id="postbox"><p><?php echo $postText; ?></p><?php if($ifImage):?> <img src="<?php echo $ifImage; ?>" alt="" height="300" width="300" /><?php endif; ?></div>
                                 	<div class="bottom-bar">
					                        ...
					                        <div id="likes" >
												...
												<?php else: ?><p>Likes yet to come</p><?php endif; ?>
											</div>
			      ...
			      <?php endforeach;?>
					...
					?>
			            <div class="post" id="<?php echo $postID; ?>">
			                 <div class="pdata">
                                  <div class="entry">
                                         <a href="pages.php?id=<?php echo $pageID; ?>" class="entry2"><img src="<?php echo getPagePic($pageID); ?>" alt="<?php echo "$name"; ?>" height="60" width="60" /></a>
                                         <a href="pages.php?id=<?php echo $pageID; ?>" class="puser"><p><?php echo "$name"; ?></p></a>
                                         <div id="postbox">
                                         	<p><?php echo $postText; ?></p>
                                         	<?php if($ifImage):?> <img src="<?php echo $ifImage; ?>" alt="" height="300" width="300" /> <?php endif; ?>
                                         </div>
                                          <div class="bottom-bar">
				                                    <div id="bottom_post">
				                                          <p><?php echo $time; ?></p>
													...
													<div id="likes" ><p><?php if ($likes > 0) : echo $likes; ?> people liked this</p></div>
													<?php else: ?><p>Likes yet to come<p></div><?php endif; ?>
													 <?php foreach ($comments as $index => $comment): ?>
													 <?php 		$userID = $comment['userID'];
													 			$name   = $comment['commentername'];
																$pic = $comment['commenterpic'];
																$fname  = $name['fname'];
																$lname  = $name['lname'];
																$commentText = $comment['comment'];
																$time = $comment['timeOn'];
													 ?>
					                                 <div class="comments"><img src="<?php echo $pic; ?>" alt="<?php echo "$fname $lname"; ?>" height="30" width="30"/>
