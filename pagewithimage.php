                   ...
                   <div id="page-post-box">  
                       <div id="page-post">   
                          <img src="<?php echo $pagepic; ?>" alt="" width="50	" height="50"/>
		                    <div id="types">
		                        <ul>
		                            <li><a href="pages.php?action=showpage&id=<?php echo $pageID; ?>" >Text/Link</a></li>
	             	                <li><a href="pages.php?action=topicpost&id=<?php echo $pageID; ?>">Image</a></li>
		                        </ul>
	                       </div>
                          <div id="box">
		                          <form id="status-form" action="pages.php" method="post" enctype="multipart/form-data" >
		                          <div id="textBox" >
		                          <input type="text" name="status" id="share-text" class="share-text" title="What's on your mind ? "/>
								  <input type="hidden" name="action" value="picpost" />
